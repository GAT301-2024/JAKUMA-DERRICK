...
// WiFi Credentials
const char* ssid = "BUY...DJAK";
const char* password = "Jarrick@14";
...
String htmlPage()
{
  ...
  <head>
      ...
      <title>Derrick Systems - Smart Remote Lighting</title>
      <style>
          body {
  ...
  <body>
      ...
      <footer>&copy; 2025 Derrick Systems | BYTEBLOOM TEAM GAT301</footer>
  </body>
  </html>
  )rawliteral";
